...
$config = array(
    ...
    'default-sp' => array(
        ...
        'entityID' => 'https://sp1.simplesamlphp.test.umich.localhost/module.php/saml/sp/metadata.php/default-sp',

        // The entity ID of the IdP this should SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'https://shib-idp-staging.dsc.umich.edu/idp/shibboleth',
